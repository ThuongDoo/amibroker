...
export class StockService {
  ...
  //     ADX: '28.71',
  //     Beta: '0.24',
  //     Bienloinhuangop: '0.27',
  //     Bienloinhuanhoatdong: '-0.14',
  //     BookValuePerShare: '17.84',
  //     ChamdaiduoiBB: '0',
  //     ChamdaitrenBB: '0',
  //     DMI: '30.48',
  //     DMIminus: '38.11',
  ...
  //     'Tang/Giam': '-0.01',
  //     'Tang/Giam (%)': '-0.13',
  //     TangtruongLNhangquy: '29.42',
  //     Tangtruongdoanhthutheoquy: '-20.56',
  //     Ticker: 'HAS',
  //     Trend: '0',
  //     TyleCPluuhanh: '7800000.00',
  //     Volume: '5100',
  //   },
  //   {
  //     ADX: '28.71',
